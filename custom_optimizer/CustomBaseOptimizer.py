...
class CustomBaseOptimizer(object):
    """Base class for optimizers.
    ...
    def compute_gradients(self, loss, var_list=None,
        ...
        """
        if gate_gradients not in [CustomBaseOptimizer.GATE_NONE, CustomBaseOptimizer.GATE_OP,
                                  CustomBaseOptimizer.GATE_GRAPH]:
        ...
        grads = gradients.gradients(
            ...
            gate_gradients=(gate_gradients == CustomBaseOptimizer.GATE_OP),
            aggregation_method=aggregation_method,
            colocate_gradients_with_ops=colocate_gradients_with_ops)
        if gate_gradients == CustomBaseOptimizer.GATE_GRAPH:
